    ...
    <div class="container container-small flex-content-center">
        <div class="tomo-body-fullw">
            <div class="info-header">
                ...
                <p>Current {{ token.name }} fee fund: {{ currentPoolingFee }} RUPX</p>
            </div>
            <b-form
                class="tmp-form-one"
                novalidate
                ...
                <b-form-group
                    :description="`TX fee: 0.0005 RUPX, Available balance: ${showingBalance} RUPX`"
                    ...
                    <b-form-input
                        v-model="depositFee"
                        type="number"
                        placeholder="How much RUPX do you want to deposit?..."
                        @input="onChange"/>
                    <div
